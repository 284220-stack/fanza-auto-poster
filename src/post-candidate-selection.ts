...
export type CandidateSource = { productId: number; title: string; affiliateUrl: string | null; sampleVideoUrl?: string | null; thumbnailUrl?: string | null; releaseDate?: string | null; isSale: boolean; status: string; favorite: boolean; actressNames: string[]; enabledActressNames: string[]; enabledNewReleaseActressNames: string[]; actressPriority: number; hasRecentParentPost: boolean; hasPendingReply: boolean; discountPercent?: number; campaignName?: string };
export type PostCandidate = { productId: number; category: CandidateCategory; title: string; actressNames: string[]; affiliateUrl: string; sampleVideoUrl?: string; thumbnailUrl?: string; releaseDate?: string; discountPercent?: number; campaignName?: string; selectionReasons: string[]; priorityScore: number };
